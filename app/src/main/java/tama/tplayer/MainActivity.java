...
public class MainActivity extends AppCompatActivity implements MediaPlayerControl {
    ...
    private void CheckPermissions() {
        String[] permissionsToCheck = {Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.WAKE_LOCK, Manifest.permission.READ_PHONE_STATE};
        ...
        if (shouldAskForPermissions)
            ActivityCompat.requestPermissions(this, permissionsToCheck, 1);
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_shuffle:
                if (musicSrv.setShuffle())
                    ...
                    item.setIcon(R.drawable.rand_inactive);
                break;
